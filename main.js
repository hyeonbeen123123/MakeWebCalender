...
const holidayData = {
  ...
  function generateCalendar(year, month) {
    ...
    monthTitle.textContent = `${year}년 ${month + 1}월`; // 0월 부터 시작하기 떄문에 +1 해줌
...
// 이전으로 버튼을 클릭했을 때 // 이전 버튼 없앰
// function backToSelectMonth() {
//     const calendarContainer = document.getElementById("calendar-container");
//     calendarContainer.innerHTML = '';
//     document.getElementById("back-to-select-month").style.display = "none";
// }
